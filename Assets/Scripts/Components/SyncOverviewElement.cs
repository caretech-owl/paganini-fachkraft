...
public class SyncOverviewElement : MonoBehaviour
{
    ...
    private SynchronizationController SynchronizationHandler;
    ...
    public void InstantiateSyncOverviewElement(int id, string start, string finish, string date, string status, SynchronizationController synchronizationHandler)
    {
        Id = id;
