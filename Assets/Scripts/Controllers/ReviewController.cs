...
public class ReviewController : MonoBehaviour
{
    ...
    private InternalDataModel.DataOfImportedERW Erw;
    ...
    {
        int currentErw = 4;
        Erw = InternalDataModelController.GetInternalDataModelController().idm.exploritoryRouteWalks.FindLast(x => x.Id == currentErw);
