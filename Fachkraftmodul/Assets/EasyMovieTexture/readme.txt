...
------------------------------------------------------------------------------------------
Update ( Ver. 3.81)
1.android ARM64 library problem fix

Update ( Ver. 3.8)

1. Changed to use Unity VideoPlayer instead of ffmpeg in PC, EDITOR
2. Safe code removal
3. Removed OpenGL ES code from the latest version of iOS
